...
parser.add_argument('input_image_dir', type=str, default='data/phones',
                    help='the input directory of the whole images')
parser.add_argument('input_patch_dir', type=str, default='data/cracks',
                    help='the input directory of the patche to stitch')
...
phone_dir = args.input_image_dir
crack_dir = args.input_patch_dir
